...
public final class GraphOperation extends AbstractOperation {
  ...
  Tensor<?> tensor(int outputIdx) {
    throw new IllegalStateException("Cannot access directly the tensor of an operation output in graph execution mode, "
        + "the tensor should be fetched when running a session instead");
  }
