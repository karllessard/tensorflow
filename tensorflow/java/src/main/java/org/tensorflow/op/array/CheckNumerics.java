...
public final class CheckNumerics<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> CheckNumerics<T> create(Scope scope, Operand<T> tensor, String message) {
