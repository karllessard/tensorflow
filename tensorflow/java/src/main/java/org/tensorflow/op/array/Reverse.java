...
public final class Reverse<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> Reverse<T> create(Scope scope, Operand<T> tensor, Operand<Boolean> dims) {
    OperationBuilder opBuilder = scope.graph().opBuilder("Reverse", scope.makeOpName("Reverse"));
