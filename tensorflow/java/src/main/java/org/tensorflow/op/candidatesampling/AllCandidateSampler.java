...
public final class AllCandidateSampler extends PrimitiveOp {
   ...
   **/
  public static AllCandidateSampler create(Scope scope, Operand<Long> trueClasses, Integer numTrue, Integer numSampled, Boolean unique) {
   ...
   * @return a new instance of AllCandidateSampler
   **/
  public static AllCandidateSampler create(Scope scope, Operand<Long> trueClasses, Integer numTrue, Integer numSampled, Boolean unique, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("AllCandidateSampler", scope.makeOpName("AllCandidateSampler"));
    opBuilder.addInput(trueClasses.asOutput());
    opBuilder.setAttr("numTrue", numTrue);
    opBuilder.setAttr("numSampled", numSampled);
