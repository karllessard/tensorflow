...
public final class LearnedUnigramCandidateSampler extends PrimitiveOp {
   ...
   **/
  public static LearnedUnigramCandidateSampler create(Scope scope, Operand<Long> trueClasses, Integer numTrue, Integer numSampled, Boolean unique, Integer rangeMax) {
   ...
   * @return a new instance of LearnedUnigramCandidateSampler
   **/
  public static LearnedUnigramCandidateSampler create(Scope scope, Operand<Long> trueClasses, Integer numTrue, Integer numSampled, Boolean unique, Integer rangeMax, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("LearnedUnigramCandidateSampler", scope.makeOpName("LearnedUnigramCandidateSampler"));
    opBuilder.addInput(trueClasses.asOutput());
    opBuilder.setAttr("numTrue", numTrue);
    opBuilder.setAttr("numSampled", numSampled);
