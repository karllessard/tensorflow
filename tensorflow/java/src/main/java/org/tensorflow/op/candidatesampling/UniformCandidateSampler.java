...
public final class UniformCandidateSampler extends PrimitiveOp {
   ...
   **/
  public static UniformCandidateSampler create(Scope scope, Operand<Long> trueClasses, Integer numTrue, Integer numSampled, Boolean unique, Integer rangeMax) {
   ...
   * @return a new instance of UniformCandidateSampler
   **/
  public static UniformCandidateSampler create(Scope scope, Operand<Long> trueClasses, Integer numTrue, Integer numSampled, Boolean unique, Integer rangeMax, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("UniformCandidateSampler", scope.makeOpName("UniformCandidateSampler"));
    opBuilder.addInput(trueClasses.asOutput());
    opBuilder.setAttr("numTrue", numTrue);
    opBuilder.setAttr("numSampled", numSampled);
