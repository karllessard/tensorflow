...
public final class FIFOQueue extends PrimitiveOp implements Operand<String> {
   ...
   **/
  public static FIFOQueue create(Scope scope, List<DataType> componentTypes) {
    OperationBuilder opBuilder = scope.graph().opBuilder("FIFOQueue", scope.makeOpName("FIFOQueue"));
