...
public final class MapStage extends PrimitiveOp {
   ...
   **/
  public static MapStage create(Scope scope, Operand<Long> key, Operand<Integer> indices, Iterable<Operand<?>> values, List<DataType> dtypes) {
   ...
   * @return a new instance of MapStage
   **/
  public static MapStage create(Scope scope, Operand<Long> key, Operand<Integer> indices, Iterable<Operand<?>> values, List<DataType> dtypes, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("MapStage", scope.makeOpName("MapStage"));
    opBuilder.addInput(key.asOutput());
    opBuilder.addInput(indices.asOutput());
    opBuilder.addInputList(Operands.asOutputs(values));
