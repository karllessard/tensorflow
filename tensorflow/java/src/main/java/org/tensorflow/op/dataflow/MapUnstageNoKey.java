...
public final class MapUnstageNoKey extends PrimitiveOp {
   ...
   **/
  public static MapUnstageNoKey create(Scope scope, Operand<Integer> indices, List<DataType> dtypes) {
   ...
   * @return a new instance of MapUnstageNoKey
   **/
  public static MapUnstageNoKey create(Scope scope, Operand<Integer> indices, List<DataType> dtypes, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("MapUnstageNoKey", scope.makeOpName("MapUnstageNoKey"));
    opBuilder.addInput(indices.asOutput());
    opBuilder.setAttr("dtypes", dtypes.toArray(new DataType[dtypes.size()]));
