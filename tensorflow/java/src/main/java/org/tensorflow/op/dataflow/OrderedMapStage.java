...
public final class OrderedMapStage extends PrimitiveOp {
   ...
   **/
  public static OrderedMapStage create(Scope scope, Operand<Long> key, Operand<Integer> indices, Iterable<Operand<?>> values, List<DataType> dtypes) {
   ...
   * @return a new instance of OrderedMapStage
   **/
  public static OrderedMapStage create(Scope scope, Operand<Long> key, Operand<Integer> indices, Iterable<Operand<?>> values, List<DataType> dtypes, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("OrderedMapStage", scope.makeOpName("OrderedMapStage"));
    opBuilder.addInput(key.asOutput());
    opBuilder.addInput(indices.asOutput());
    opBuilder.addInputList(Operands.asOutputs(values));
