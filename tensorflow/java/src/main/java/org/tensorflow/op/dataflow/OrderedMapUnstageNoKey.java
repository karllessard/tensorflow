...
public final class OrderedMapUnstageNoKey extends PrimitiveOp {
   ...
   **/
  public static OrderedMapUnstageNoKey create(Scope scope, Operand<Integer> indices, List<DataType> dtypes) {
   ...
   * @return a new instance of OrderedMapUnstageNoKey
   **/
  public static OrderedMapUnstageNoKey create(Scope scope, Operand<Integer> indices, List<DataType> dtypes, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("OrderedMapUnstageNoKey", scope.makeOpName("OrderedMapUnstageNoKey"));
    opBuilder.addInput(indices.asOutput());
    opBuilder.setAttr("dtypes", dtypes.toArray(new DataType[dtypes.size()]));
