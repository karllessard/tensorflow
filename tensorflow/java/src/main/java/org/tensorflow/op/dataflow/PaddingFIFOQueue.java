...
public final class PaddingFIFOQueue extends PrimitiveOp implements Operand<String> {
   ...
   **/
  public static PaddingFIFOQueue create(Scope scope, List<DataType> componentTypes) {
    OperationBuilder opBuilder = scope.graph().opBuilder("PaddingFIFOQueue", scope.makeOpName("PaddingFIFOQueue"));
