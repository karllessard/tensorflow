...
public final class PaddingFIFOQueueV2 extends PrimitiveOp implements Operand<Object> {
  ...
  /**
   * Factory method to create a class to wrap a new PaddingFIFOQueueV2 operation to the graph.
   * 
   * @param scope Current graph scope
   * @param componentTypes
   * @return a new instance of PaddingFIFOQueueV2
   **/
  public static PaddingFIFOQueueV2 create(Scope scope, List<DataType> componentTypes) {
    OperationBuilder opBuilder = scope.graph().opBuilder("PaddingFIFOQueueV2", scope.makeOpName("PaddingFIFOQueueV2"));
    opBuilder.setAttr("componentTypes", componentTypes.toArray(new DataType[componentTypes.size()]));
    return new PaddingFIFOQueueV2(opBuilder.build());
  }
   ...
   * @return a new instance of PaddingFIFOQueueV2
   **/
  public static PaddingFIFOQueueV2 create(Scope scope, List<DataType> componentTypes, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("PaddingFIFOQueueV2", scope.makeOpName("PaddingFIFOQueueV2"));
    opBuilder.setAttr("componentTypes", componentTypes.toArray(new DataType[componentTypes.size()]));
   ...
   **/
  @SuppressWarnings("unchecked")
  private PaddingFIFOQueueV2(Operation operation) {
    super(operation);
    int outputIdx = 0;
