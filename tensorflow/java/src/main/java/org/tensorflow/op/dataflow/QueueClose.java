...
public final class QueueClose extends PrimitiveOp {
   ...
   **/
  public static QueueClose create(Scope scope, Operand<String> handle) {
    OperationBuilder opBuilder = scope.graph().opBuilder("QueueClose", scope.makeOpName("QueueClose"));
   ...
   * @return a new instance of QueueClose
   **/
  public static QueueClose create(Scope scope, Operand<String> handle, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("QueueClose", scope.makeOpName("QueueClose"));
    opBuilder.addInput(handle.asOutput());
