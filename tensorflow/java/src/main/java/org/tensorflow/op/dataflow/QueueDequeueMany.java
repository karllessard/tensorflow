...
public final class QueueDequeueMany extends PrimitiveOp implements Iterable<Operand<DataType>> {
   ...
   **/
  public static QueueDequeueMany create(Scope scope, Operand<String> handle, Operand<Integer> n, List<DataType> componentTypes) {
    OperationBuilder opBuilder = scope.graph().opBuilder("QueueDequeueMany", scope.makeOpName("QueueDequeueMany"));
   ...
   * @return a new instance of QueueDequeueMany
   **/
  public static QueueDequeueMany create(Scope scope, Operand<String> handle, Operand<Integer> n, List<DataType> componentTypes, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("QueueDequeueMany", scope.makeOpName("QueueDequeueMany"));
    opBuilder.addInput(handle.asOutput());
    opBuilder.addInput(n.asOutput());
    opBuilder.setAttr("componentTypes", componentTypes.toArray(new DataType[componentTypes.size()]));
