...
public final class QueueDequeueUpTo extends PrimitiveOp implements Iterable<Operand<DataType>> {
   ...
   **/
  public static QueueDequeueUpTo create(Scope scope, Operand<String> handle, Operand<Integer> n, List<DataType> componentTypes) {
    OperationBuilder opBuilder = scope.graph().opBuilder("QueueDequeueUpTo", scope.makeOpName("QueueDequeueUpTo"));
   ...
   * @return a new instance of QueueDequeueUpTo
   **/
  public static QueueDequeueUpTo create(Scope scope, Operand<String> handle, Operand<Integer> n, List<DataType> componentTypes, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("QueueDequeueUpTo", scope.makeOpName("QueueDequeueUpTo"));
    opBuilder.addInput(handle.asOutput());
    opBuilder.addInput(n.asOutput());
    opBuilder.setAttr("componentTypes", componentTypes.toArray(new DataType[componentTypes.size()]));
