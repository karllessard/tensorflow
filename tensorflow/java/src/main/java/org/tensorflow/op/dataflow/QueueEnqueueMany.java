...
public final class QueueEnqueueMany extends PrimitiveOp {
   ...
   **/
  public static QueueEnqueueMany create(Scope scope, Operand<String> handle, Iterable<Operand<?>> components) {
    OperationBuilder opBuilder = scope.graph().opBuilder("QueueEnqueueMany", scope.makeOpName("QueueEnqueueMany"));
   ...
   * @return a new instance of QueueEnqueueMany
   **/
  public static QueueEnqueueMany create(Scope scope, Operand<String> handle, Iterable<Operand<?>> components, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("QueueEnqueueMany", scope.makeOpName("QueueEnqueueMany"));
    opBuilder.addInput(handle.asOutput());
    opBuilder.addInputList(Operands.asOutputs(components));
