...
public final class RandomShuffleQueue extends PrimitiveOp implements Operand<String> {
   ...
   **/
  public static RandomShuffleQueue create(Scope scope, List<DataType> componentTypes) {
    OperationBuilder opBuilder = scope.graph().opBuilder("RandomShuffleQueue", scope.makeOpName("RandomShuffleQueue"));
