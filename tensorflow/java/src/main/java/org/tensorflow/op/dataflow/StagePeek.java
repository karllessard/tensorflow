...
public final class StagePeek extends PrimitiveOp implements Iterable<Operand<DataType>> {
   ...
   **/
  public static StagePeek create(Scope scope, Operand<Integer> index, List<DataType> dtypes) {
   ...
   * @return a new instance of StagePeek
   **/
  public static StagePeek create(Scope scope, Operand<Integer> index, List<DataType> dtypes, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("StagePeek", scope.makeOpName("StagePeek"));
    opBuilder.addInput(index.asOutput());
    opBuilder.setAttr("dtypes", dtypes.toArray(new DataType[dtypes.size()]));
