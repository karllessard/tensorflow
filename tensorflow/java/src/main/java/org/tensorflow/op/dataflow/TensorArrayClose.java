...
public final class TensorArrayClose extends PrimitiveOp {
   ...
   **/
  public static TensorArrayClose create(Scope scope, Operand<String> handle) {
    OperationBuilder opBuilder = scope.graph().opBuilder("TensorArrayClose", scope.makeOpName("TensorArrayClose"));
