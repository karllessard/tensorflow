...
public final class TensorArrayGrad extends PrimitiveOp implements Operand<String> {
   ...
   **/
  public static TensorArrayGrad create(Scope scope, Operand<String> handle, Operand<Float> flowIn, String source) {
    OperationBuilder opBuilder = scope.graph().opBuilder("TensorArrayGrad", scope.makeOpName("TensorArrayGrad"));
