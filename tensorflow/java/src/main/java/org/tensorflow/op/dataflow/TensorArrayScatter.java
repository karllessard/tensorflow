...
public final class TensorArrayScatter extends PrimitiveOp implements Operand<Float> {
   ...
   **/
  public static <T> TensorArrayScatter create(Scope scope, Operand<String> handle, Operand<Integer> indices, Operand<T> value, Operand<Float> flowIn) {
    OperationBuilder opBuilder = scope.graph().opBuilder("TensorArrayScatter", scope.makeOpName("TensorArrayScatter"));
