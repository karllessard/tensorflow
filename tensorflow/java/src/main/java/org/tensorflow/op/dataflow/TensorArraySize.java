...
public final class TensorArraySize extends PrimitiveOp implements Operand<Integer> {
   ...
   **/
  public static TensorArraySize create(Scope scope, Operand<String> handle, Operand<Float> flowIn) {
    OperationBuilder opBuilder = scope.graph().opBuilder("TensorArraySize", scope.makeOpName("TensorArraySize"));
