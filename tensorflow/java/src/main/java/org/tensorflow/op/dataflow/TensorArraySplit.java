...
public final class TensorArraySplit extends PrimitiveOp implements Operand<Float> {
   ...
   **/
  public static <T> TensorArraySplit create(Scope scope, Operand<String> handle, Operand<T> value, Operand<Long> lengths, Operand<Float> flowIn) {
    OperationBuilder opBuilder = scope.graph().opBuilder("TensorArraySplit", scope.makeOpName("TensorArraySplit"));
