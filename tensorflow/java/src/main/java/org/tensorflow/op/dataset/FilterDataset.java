...
public final class FilterDataset extends PrimitiveOp implements Operand<Object> {
  
  /**
   * Factory method to create a class to wrap a new FilterDataset operation to the graph.
   * 
   ...
   **/
  public static FilterDataset create(Scope scope, Operand<?> inputDataset, Iterable<Operand<?>> otherArguments, Object predicate, List<DataType> outputTypes, List<Shape> outputShapes) {
    OperationBuilder opBuilder = scope.graph().opBuilder("FilterDataset", scope.makeOpName("FilterDataset"));
