...
public final class MapDataset extends PrimitiveOp implements Operand<Object> {
  
  /**
   * Factory method to create a class to wrap a new MapDataset operation to the graph.
   * 
   ...
   **/
  public static MapDataset create(Scope scope, Operand<?> inputDataset, Iterable<Operand<?>> otherArguments, Object f, List<DataType> outputTypes, List<Shape> outputShapes) {
    OperationBuilder opBuilder = scope.graph().opBuilder("MapDataset", scope.makeOpName("MapDataset"));
