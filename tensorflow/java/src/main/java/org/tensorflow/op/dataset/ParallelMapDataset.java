...
public final class ParallelMapDataset extends PrimitiveOp implements Operand<Object> {
  
  /**
   * Factory method to create a class to wrap a new ParallelMapDataset operation to the graph.
   * 
   ...
   **/
  public static ParallelMapDataset create(Scope scope, Operand<?> inputDataset, Iterable<Operand<?>> otherArguments, Operand<Integer> numParallelCalls, Object f, List<DataType> outputTypes, List<Shape> outputShapes) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ParallelMapDataset", scope.makeOpName("ParallelMapDataset"));
