...
public final class DrawBoundingBoxes<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> DrawBoundingBoxes<T> create(Scope scope, Operand<T> images, Operand<Float> boxes) {
