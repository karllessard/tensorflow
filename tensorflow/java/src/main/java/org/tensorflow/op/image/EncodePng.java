...
public final class EncodePng extends PrimitiveOp implements Operand<String> {
  ...
  public static class Options {
     ...
     * @param compression
     **/
    public Options compression(Integer compression) {
   ...
   **/
  public static <T> EncodePng create(Scope scope, Operand<T> image) {
   ...
   * @return a new instance of EncodePng
   **/
  public static <T> EncodePng create(Scope scope, Operand<T> image, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("EncodePng", scope.makeOpName("EncodePng"));
    opBuilder.addInput(image.asOutput());
    if (options.compression != null) {
      opBuilder.setAttr("compression", options.compression);
    }
    return new EncodePng(opBuilder.build());
  }
   ...
   * @param compression
   **/
  public static Options compression(Integer compression) {
