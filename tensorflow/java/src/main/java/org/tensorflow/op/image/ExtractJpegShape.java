...
public final class ExtractJpegShape<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> ExtractJpegShape<T> create(Scope scope, Operand<String> contents, Class<T> output_type) {
