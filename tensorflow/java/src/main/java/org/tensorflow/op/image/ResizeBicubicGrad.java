...
public final class ResizeBicubicGrad<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> ResizeBicubicGrad<T> create(Scope scope, Operand<Float> grads, Operand<T> originalImage) {
   ...
   * @return a new instance of ResizeBicubicGrad
   **/
  public static <T> ResizeBicubicGrad<T> create(Scope scope, Operand<Float> grads, Operand<T> originalImage, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ResizeBicubicGrad", scope.makeOpName("ResizeBicubicGrad"));
    opBuilder.addInput(grads.asOutput());
    opBuilder.addInput(originalImage.asOutput());
