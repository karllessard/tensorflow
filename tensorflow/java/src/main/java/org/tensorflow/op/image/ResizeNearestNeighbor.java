...
public final class ResizeNearestNeighbor<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> ResizeNearestNeighbor<T> create(Scope scope, Operand<T> images, Operand<Integer> size) {
   ...
   * @return a new instance of ResizeNearestNeighbor
   **/
  public static <T> ResizeNearestNeighbor<T> create(Scope scope, Operand<T> images, Operand<Integer> size, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ResizeNearestNeighbor", scope.makeOpName("ResizeNearestNeighbor"));
    opBuilder.addInput(images.asOutput());
    opBuilder.addInput(size.asOutput());
