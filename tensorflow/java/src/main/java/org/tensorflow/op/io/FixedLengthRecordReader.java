...
public final class FixedLengthRecordReader extends PrimitiveOp implements Operand<String> {
   ...
   **/
  public static FixedLengthRecordReader create(Scope scope, Integer recordBytes) {
    OperationBuilder opBuilder = scope.graph().opBuilder("FixedLengthRecordReader", scope.makeOpName("FixedLengthRecordReader"));
   ...
   * @return a new instance of FixedLengthRecordReader
   **/
  public static FixedLengthRecordReader create(Scope scope, Integer recordBytes, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("FixedLengthRecordReader", scope.makeOpName("FixedLengthRecordReader"));
    opBuilder.setAttr("recordBytes", recordBytes);
