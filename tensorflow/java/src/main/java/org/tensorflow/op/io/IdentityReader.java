...
public final class IdentityReader extends PrimitiveOp implements Operand<String> {
   ...
   **/
  public static IdentityReader create(Scope scope) {
    OperationBuilder opBuilder = scope.graph().opBuilder("IdentityReader", scope.makeOpName("IdentityReader"));
