...
public final class ReaderNumWorkUnitsCompleted extends PrimitiveOp implements Operand<Long> {
   ...
   **/
  public static ReaderNumWorkUnitsCompleted create(Scope scope, Operand<String> readerHandle) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ReaderNumWorkUnitsCompleted", scope.makeOpName("ReaderNumWorkUnitsCompleted"));
