...
public final class ReaderReset extends PrimitiveOp {
   ...
   **/
  public static ReaderReset create(Scope scope, Operand<String> readerHandle) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ReaderReset", scope.makeOpName("ReaderReset"));
