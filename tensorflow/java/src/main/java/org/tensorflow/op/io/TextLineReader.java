...
public final class TextLineReader extends PrimitiveOp implements Operand<String> {
   ...
   **/
  public static TextLineReader create(Scope scope) {
    OperationBuilder opBuilder = scope.graph().opBuilder("TextLineReader", scope.makeOpName("TextLineReader"));
