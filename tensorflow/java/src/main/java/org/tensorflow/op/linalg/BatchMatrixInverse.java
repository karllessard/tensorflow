...
public final class BatchMatrixInverse<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> BatchMatrixInverse<T> create(Scope scope, Operand<T> input) {
   ...
   * @return a new instance of BatchMatrixInverse
   **/
  public static <T> BatchMatrixInverse<T> create(Scope scope, Operand<T> input, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("BatchMatrixInverse", scope.makeOpName("BatchMatrixInverse"));
    opBuilder.addInput(input.asOutput());
