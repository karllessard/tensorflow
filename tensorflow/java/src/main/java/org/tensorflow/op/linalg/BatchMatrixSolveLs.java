...
public final class BatchMatrixSolveLs<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> BatchMatrixSolveLs<T> create(Scope scope, Operand<T> matrix, Operand<T> rhs, Operand<Double> l2Regularizer) {
   ...
   * @return a new instance of BatchMatrixSolveLs
   **/
  public static <T> BatchMatrixSolveLs<T> create(Scope scope, Operand<T> matrix, Operand<T> rhs, Operand<Double> l2Regularizer, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("BatchMatrixSolveLs", scope.makeOpName("BatchMatrixSolveLs"));
    opBuilder.addInput(matrix.asOutput());
    opBuilder.addInput(rhs.asOutput());
    opBuilder.addInput(l2Regularizer.asOutput());
