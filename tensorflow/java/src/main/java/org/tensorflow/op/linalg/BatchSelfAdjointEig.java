...
public final class BatchSelfAdjointEig<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> BatchSelfAdjointEig<T> create(Scope scope, Operand<T> input) {
