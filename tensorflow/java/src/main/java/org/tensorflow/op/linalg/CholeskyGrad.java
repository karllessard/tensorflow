...
public final class CholeskyGrad<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> CholeskyGrad<T> create(Scope scope, Operand<T> l, Operand<T> grad) {
