...
public final class ArgMax<V> extends PrimitiveOp implements Operand<V> {
   ...
   **/
  public static <T, U, V> ArgMax<V> create(Scope scope, Operand<T> input, Operand<U> dimension, Class<V> output_type) {
