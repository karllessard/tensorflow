...
public final class Bincount<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> Bincount<T> create(Scope scope, Operand<Integer> arr, Operand<Integer> size, Operand<T> weights) {
