...
public final class LinSpace<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> LinSpace<T> create(Scope scope, Operand<T> start, Operand<T> stop, Operand<U> num) {
