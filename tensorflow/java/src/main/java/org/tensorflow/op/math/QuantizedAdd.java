...
public final class QuantizedAdd<V> extends PrimitiveOp {
   ...
   **/
  public static <T, U, V> QuantizedAdd<V> create(Scope scope, Operand<T> x, Operand<U> y, Operand<Float> minX, Operand<Float> maxX, Operand<Float> minY, Operand<Float> maxY, Class<V> Toutput) {
