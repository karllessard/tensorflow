...
public final class SegmentMax<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> SegmentMax<T> create(Scope scope, Operand<T> data, Operand<U> segmentIds) {
