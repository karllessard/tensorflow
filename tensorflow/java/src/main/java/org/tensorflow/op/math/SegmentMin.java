...
public final class SegmentMin<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> SegmentMin<T> create(Scope scope, Operand<T> data, Operand<U> segmentIds) {
