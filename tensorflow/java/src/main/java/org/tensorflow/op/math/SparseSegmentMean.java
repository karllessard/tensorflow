...
public final class SparseSegmentMean<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> SparseSegmentMean<T> create(Scope scope, Operand<T> data, Operand<U> indices, Operand<Integer> segmentIds) {
