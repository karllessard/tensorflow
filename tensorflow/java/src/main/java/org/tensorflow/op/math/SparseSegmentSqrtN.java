...
public final class SparseSegmentSqrtN<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> SparseSegmentSqrtN<T> create(Scope scope, Operand<T> data, Operand<U> indices, Operand<Integer> segmentIds) {
