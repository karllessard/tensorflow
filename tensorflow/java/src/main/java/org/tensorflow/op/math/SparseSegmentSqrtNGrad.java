...
public final class SparseSegmentSqrtNGrad<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> SparseSegmentSqrtNGrad<T> create(Scope scope, Operand<T> grad, Operand<U> indices, Operand<Integer> segmentIds, Operand<Integer> outputDim0) {
