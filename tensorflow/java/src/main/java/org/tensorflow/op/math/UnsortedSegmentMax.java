...
public final class UnsortedSegmentMax<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> UnsortedSegmentMax<T> create(Scope scope, Operand<T> data, Operand<U> segmentIds, Operand<Integer> numSegments) {
