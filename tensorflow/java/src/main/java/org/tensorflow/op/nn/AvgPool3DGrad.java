...
public final class AvgPool3DGrad<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> AvgPool3DGrad<T> create(Scope scope, Operand<Integer> origInputShape, Operand<T> grad, List<Integer> ksize, List<Integer> strides, String padding) {
   ...
   * @return a new instance of AvgPool3DGrad
   **/
  public static <T> AvgPool3DGrad<T> create(Scope scope, Operand<Integer> origInputShape, Operand<T> grad, List<Integer> ksize, List<Integer> strides, String padding, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("AvgPool3DGrad", scope.makeOpName("AvgPool3DGrad"));
    opBuilder.addInput(origInputShape.asOutput());
    opBuilder.addInput(grad.asOutput());
    long[] ksizeArray = new long[ksize.size()];
