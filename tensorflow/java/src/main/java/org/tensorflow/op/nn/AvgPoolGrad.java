...
public final class AvgPoolGrad<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> AvgPoolGrad<T> create(Scope scope, Operand<Integer> origInputShape, Operand<T> grad, List<Integer> ksize, List<Integer> strides, String padding) {
   ...
   * @return a new instance of AvgPoolGrad
   **/
  public static <T> AvgPoolGrad<T> create(Scope scope, Operand<Integer> origInputShape, Operand<T> grad, List<Integer> ksize, List<Integer> strides, String padding, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("AvgPoolGrad", scope.makeOpName("AvgPoolGrad"));
    opBuilder.addInput(origInputShape.asOutput());
    opBuilder.addInput(grad.asOutput());
    long[] ksizeArray = new long[ksize.size()];
