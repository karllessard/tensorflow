...
public final class Conv2DBackpropFilter<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> Conv2DBackpropFilter<T> create(Scope scope, Operand<T> input, Operand<Integer> filterSizes, Operand<T> outBackprop, List<Integer> strides, String padding) {
   ...
   * @return a new instance of Conv2DBackpropFilter
   **/
  public static <T> Conv2DBackpropFilter<T> create(Scope scope, Operand<T> input, Operand<Integer> filterSizes, Operand<T> outBackprop, List<Integer> strides, String padding, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("Conv2DBackpropFilter", scope.makeOpName("Conv2DBackpropFilter"));
    opBuilder.addInput(input.asOutput());
    opBuilder.addInput(filterSizes.asOutput());
    opBuilder.addInput(outBackprop.asOutput());
