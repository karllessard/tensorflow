...
public final class Conv2DBackpropInput<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> Conv2DBackpropInput<T> create(Scope scope, Operand<Integer> inputSizes, Operand<T> filter, Operand<T> outBackprop, List<Integer> strides, String padding) {
   ...
   * @return a new instance of Conv2DBackpropInput
   **/
  public static <T> Conv2DBackpropInput<T> create(Scope scope, Operand<Integer> inputSizes, Operand<T> filter, Operand<T> outBackprop, List<Integer> strides, String padding, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("Conv2DBackpropInput", scope.makeOpName("Conv2DBackpropInput"));
    opBuilder.addInput(inputSizes.asOutput());
    opBuilder.addInput(filter.asOutput());
    opBuilder.addInput(outBackprop.asOutput());
