...
public final class Conv3DBackpropFilter<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> Conv3DBackpropFilter<T> create(Scope scope, Operand<T> input, Operand<T> filter, Operand<T> outBackprop, List<Integer> strides, String padding) {
