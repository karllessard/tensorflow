...
public final class Conv3DBackpropFilterV2<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> Conv3DBackpropFilterV2<T> create(Scope scope, Operand<T> input, Operand<Integer> filterSizes, Operand<T> outBackprop, List<Integer> strides, String padding) {
   ...
   * @return a new instance of Conv3DBackpropFilterV2
   **/
  public static <T> Conv3DBackpropFilterV2<T> create(Scope scope, Operand<T> input, Operand<Integer> filterSizes, Operand<T> outBackprop, List<Integer> strides, String padding, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("Conv3DBackpropFilterV2", scope.makeOpName("Conv3DBackpropFilterV2"));
    opBuilder.addInput(input.asOutput());
    opBuilder.addInput(filterSizes.asOutput());
    opBuilder.addInput(outBackprop.asOutput());
