...
public final class DepthwiseConv2dNative<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> DepthwiseConv2dNative<T> create(Scope scope, Operand<T> input, Operand<T> filter, List<Integer> strides, String padding) {
   ...
   * @return a new instance of DepthwiseConv2dNative
   **/
  public static <T> DepthwiseConv2dNative<T> create(Scope scope, Operand<T> input, Operand<T> filter, List<Integer> strides, String padding, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("DepthwiseConv2dNative", scope.makeOpName("DepthwiseConv2dNative"));
    opBuilder.addInput(input.asOutput());
    opBuilder.addInput(filter.asOutput());
    long[] stridesArray = new long[strides.size()];
