...
public final class DepthwiseConv2dNativeBackpropFilter<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> DepthwiseConv2dNativeBackpropFilter<T> create(Scope scope, Operand<T> input, Operand<Integer> filterSizes, Operand<T> outBackprop, List<Integer> strides, String padding) {
   ...
   * @return a new instance of DepthwiseConv2dNativeBackpropFilter
   **/
  public static <T> DepthwiseConv2dNativeBackpropFilter<T> create(Scope scope, Operand<T> input, Operand<Integer> filterSizes, Operand<T> outBackprop, List<Integer> strides, String padding, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("DepthwiseConv2dNativeBackpropFilter", scope.makeOpName("DepthwiseConv2dNativeBackpropFilter"));
    opBuilder.addInput(input.asOutput());
    opBuilder.addInput(filterSizes.asOutput());
    opBuilder.addInput(outBackprop.asOutput());
