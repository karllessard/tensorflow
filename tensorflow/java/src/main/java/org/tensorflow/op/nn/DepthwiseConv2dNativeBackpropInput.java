...
public final class DepthwiseConv2dNativeBackpropInput<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> DepthwiseConv2dNativeBackpropInput<T> create(Scope scope, Operand<Integer> inputSizes, Operand<T> filter, Operand<T> outBackprop, List<Integer> strides, String padding) {
   ...
   * @return a new instance of DepthwiseConv2dNativeBackpropInput
   **/
  public static <T> DepthwiseConv2dNativeBackpropInput<T> create(Scope scope, Operand<Integer> inputSizes, Operand<T> filter, Operand<T> outBackprop, List<Integer> strides, String padding, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("DepthwiseConv2dNativeBackpropInput", scope.makeOpName("DepthwiseConv2dNativeBackpropInput"));
    opBuilder.addInput(inputSizes.asOutput());
    opBuilder.addInput(filter.asOutput());
    opBuilder.addInput(outBackprop.asOutput());
