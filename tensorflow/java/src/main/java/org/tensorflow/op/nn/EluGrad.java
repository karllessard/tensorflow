...
public final class EluGrad<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> EluGrad<T> create(Scope scope, Operand<T> gradients, Operand<T> outputs) {
