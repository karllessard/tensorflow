...
public final class FusedPadConv2D<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> FusedPadConv2D<T> create(Scope scope, Operand<T> input, Operand<Integer> paddings, Operand<T> filter, String mode, List<Integer> strides, String padding) {
