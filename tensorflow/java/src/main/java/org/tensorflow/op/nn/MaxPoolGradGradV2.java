...
public final class MaxPoolGradGradV2<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> MaxPoolGradGradV2<T> create(Scope scope, Operand<T> origInput, Operand<T> origOutput, Operand<T> grad, Operand<Integer> ksize, Operand<Integer> strides, String padding) {
   ...
   * @return a new instance of MaxPoolGradGradV2
   **/
  public static <T> MaxPoolGradGradV2<T> create(Scope scope, Operand<T> origInput, Operand<T> origOutput, Operand<T> grad, Operand<Integer> ksize, Operand<Integer> strides, String padding, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("MaxPoolGradGradV2", scope.makeOpName("MaxPoolGradGradV2"));
    opBuilder.addInput(origInput.asOutput());
    opBuilder.addInput(origOutput.asOutput());
    opBuilder.addInput(grad.asOutput());
