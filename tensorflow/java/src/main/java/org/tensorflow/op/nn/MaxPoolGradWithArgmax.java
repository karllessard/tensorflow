...
public final class MaxPoolGradWithArgmax<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> MaxPoolGradWithArgmax<T> create(Scope scope, Operand<T> input, Operand<T> grad, Operand<U> argmax, List<Integer> ksize, List<Integer> strides, String padding) {
