...
public final class QuantizedMaxPool<T> extends PrimitiveOp {
   ...
   **/
  public static <T> QuantizedMaxPool<T> create(Scope scope, Operand<T> input, Operand<Float> minInput, Operand<Float> maxInput, List<Integer> ksize, List<Integer> strides, String padding) {
