...
public final class QuantizedReluX<U> extends PrimitiveOp {
   ...
   **/
  public static <T, U> QuantizedReluX<U> create(Scope scope, Operand<T> features, Operand<Float> maxValue, Operand<Float> minFeatures, Operand<Float> maxFeatures, Class<U> out_type) {
