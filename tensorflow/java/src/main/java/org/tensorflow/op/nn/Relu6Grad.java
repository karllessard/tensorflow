...
public final class Relu6Grad<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> Relu6Grad<T> create(Scope scope, Operand<T> gradients, Operand<T> features) {
