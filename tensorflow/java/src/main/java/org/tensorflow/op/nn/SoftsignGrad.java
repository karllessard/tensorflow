...
public final class SoftsignGrad<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> SoftsignGrad<T> create(Scope scope, Operand<T> gradients, Operand<T> features) {
