...
public final class SparseSoftmaxCrossEntropyWithLogits<T> extends PrimitiveOp {
   ...
   **/
  public static <T, U> SparseSoftmaxCrossEntropyWithLogits<T> create(Scope scope, Operand<T> features, Operand<U> labels) {
