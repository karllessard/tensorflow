...
public final class Multinomial extends PrimitiveOp implements Operand<Long> {
   ...
   **/
  public static <T> Multinomial create(Scope scope, Operand<T> logits, Operand<Integer> numSamples) {
   ...
   * @return a new instance of Multinomial
   **/
  public static <T> Multinomial create(Scope scope, Operand<T> logits, Operand<Integer> numSamples, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("Multinomial", scope.makeOpName("Multinomial"));
    opBuilder.addInput(logits.asOutput());
    opBuilder.addInput(numSamples.asOutput());
