...
public final class RandomGamma<U> extends PrimitiveOp implements Operand<U> {
   ...
   **/
  public static <T, U> RandomGamma<U> create(Scope scope, Operand<T> shape, Operand<U> alpha) {
   ...
   * @return a new instance of RandomGamma
   **/
  public static <T, U> RandomGamma<U> create(Scope scope, Operand<T> shape, Operand<U> alpha, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("RandomGamma", scope.makeOpName("RandomGamma"));
    opBuilder.addInput(shape.asOutput());
    opBuilder.addInput(alpha.asOutput());
