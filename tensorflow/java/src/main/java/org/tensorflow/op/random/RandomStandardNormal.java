...
public final class RandomStandardNormal<U> extends PrimitiveOp implements Operand<U> {
   ...
   **/
  public static <T, U> RandomStandardNormal<U> create(Scope scope, Operand<T> shape, Class<U> dtype) {
    OperationBuilder opBuilder = scope.graph().opBuilder("RandomStandardNormal", scope.makeOpName("RandomStandardNormal"));
   ...
   * @return a new instance of RandomStandardNormal
   **/
  public static <T, U> RandomStandardNormal<U> create(Scope scope, Operand<T> shape, Class<U> dtype, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("RandomStandardNormal", scope.makeOpName("RandomStandardNormal"));
    opBuilder.addInput(shape.asOutput());
    opBuilder.setAttr("dtype", DataType.fromClass(dtype));
