...
public final class RandomUniform<U> extends PrimitiveOp implements Operand<U> {
   ...
   **/
  public static <T, U> RandomUniform<U> create(Scope scope, Operand<T> shape, Class<U> dtype) {
   ...
   * @return a new instance of RandomUniform
   **/
  public static <T, U> RandomUniform<U> create(Scope scope, Operand<T> shape, Class<U> dtype, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("RandomUniform", scope.makeOpName("RandomUniform"));
    opBuilder.addInput(shape.asOutput());
    opBuilder.setAttr("dtype", DataType.fromClass(dtype));
