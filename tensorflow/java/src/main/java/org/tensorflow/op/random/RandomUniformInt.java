...
public final class RandomUniformInt<U> extends PrimitiveOp implements Operand<U> {
   ...
   **/
  public static <T, U> RandomUniformInt<U> create(Scope scope, Operand<T> shape, Operand<U> minval, Operand<U> maxval) {
   ...
   * @return a new instance of RandomUniformInt
   **/
  public static <T, U> RandomUniformInt<U> create(Scope scope, Operand<T> shape, Operand<U> minval, Operand<U> maxval, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("RandomUniformInt", scope.makeOpName("RandomUniformInt"));
    opBuilder.addInput(shape.asOutput());
    opBuilder.addInput(minval.asOutput());
    opBuilder.addInput(maxval.asOutput());
