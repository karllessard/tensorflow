...
public final class TruncatedNormal<U> extends PrimitiveOp implements Operand<U> {
   ...
   **/
  public static <T, U> TruncatedNormal<U> create(Scope scope, Operand<T> shape, Class<U> dtype) {
   ...
   * @return a new instance of TruncatedNormal
   **/
  public static <T, U> TruncatedNormal<U> create(Scope scope, Operand<T> shape, Class<U> dtype, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("TruncatedNormal", scope.makeOpName("TruncatedNormal"));
    opBuilder.addInput(shape.asOutput());
    opBuilder.setAttr("dtype", DataType.fromClass(dtype));
