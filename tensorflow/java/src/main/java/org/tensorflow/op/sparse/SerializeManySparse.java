...
public final class SerializeManySparse extends PrimitiveOp implements Operand<String> {
   ...
   **/
  public static <T> SerializeManySparse create(Scope scope, Operand<Long> sparseIndices, Operand<T> sparseValues, Operand<Long> sparseShape) {
