...
public final class SparseReduceMax<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> SparseReduceMax<T> create(Scope scope, Operand<Long> inputIndices, Operand<T> inputValues, Operand<Long> inputShape, Operand<Integer> reductionAxes) {
   ...
   * @return a new instance of SparseReduceMax
   **/
  public static <T> SparseReduceMax<T> create(Scope scope, Operand<Long> inputIndices, Operand<T> inputValues, Operand<Long> inputShape, Operand<Integer> reductionAxes, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("SparseReduceMax", scope.makeOpName("SparseReduceMax"));
    opBuilder.addInput(inputIndices.asOutput());
    opBuilder.addInput(inputValues.asOutput());
    opBuilder.addInput(inputShape.asOutput());
