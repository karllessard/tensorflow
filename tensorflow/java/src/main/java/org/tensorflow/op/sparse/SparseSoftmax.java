...
public final class SparseSoftmax<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> SparseSoftmax<T> create(Scope scope, Operand<Long> spIndices, Operand<T> spValues, Operand<Long> spShape) {
