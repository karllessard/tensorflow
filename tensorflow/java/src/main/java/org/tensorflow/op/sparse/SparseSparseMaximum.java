...
public final class SparseSparseMaximum<T> extends PrimitiveOp {
   ...
   **/
  public static <T> SparseSparseMaximum<T> create(Scope scope, Operand<Long> aIndices, Operand<T> aValues, Operand<Long> aShape, Operand<Long> bIndices, Operand<T> bValues, Operand<Long> bShape) {
