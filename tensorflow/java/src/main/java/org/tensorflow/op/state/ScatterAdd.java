...
public final class ScatterAdd<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> ScatterAdd<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates) {
   ...
   * @return a new instance of ScatterAdd
   **/
  public static <T, U> ScatterAdd<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ScatterAdd", scope.makeOpName("ScatterAdd"));
    opBuilder.addInput(ref.asOutput());
    opBuilder.addInput(indices.asOutput());
    opBuilder.addInput(updates.asOutput());
