...
public final class ScatterDiv<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> ScatterDiv<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates) {
   ...
   * @return a new instance of ScatterDiv
   **/
  public static <T, U> ScatterDiv<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ScatterDiv", scope.makeOpName("ScatterDiv"));
    opBuilder.addInput(ref.asOutput());
    opBuilder.addInput(indices.asOutput());
    opBuilder.addInput(updates.asOutput());
