...
public final class ScatterMul<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> ScatterMul<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates) {
   ...
   * @return a new instance of ScatterMul
   **/
  public static <T, U> ScatterMul<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ScatterMul", scope.makeOpName("ScatterMul"));
    opBuilder.addInput(ref.asOutput());
    opBuilder.addInput(indices.asOutput());
    opBuilder.addInput(updates.asOutput());
