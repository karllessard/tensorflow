...
public final class ScatterNdAdd<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> ScatterNdAdd<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates) {
   ...
   * @return a new instance of ScatterNdAdd
   **/
  public static <T, U> ScatterNdAdd<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ScatterNdAdd", scope.makeOpName("ScatterNdAdd"));
    opBuilder.addInput(ref.asOutput());
    opBuilder.addInput(indices.asOutput());
    opBuilder.addInput(updates.asOutput());
