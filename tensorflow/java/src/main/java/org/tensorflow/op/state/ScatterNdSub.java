...
public final class ScatterNdSub<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> ScatterNdSub<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates) {
   ...
   * @return a new instance of ScatterNdSub
   **/
  public static <T, U> ScatterNdSub<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ScatterNdSub", scope.makeOpName("ScatterNdSub"));
    opBuilder.addInput(ref.asOutput());
    opBuilder.addInput(indices.asOutput());
    opBuilder.addInput(updates.asOutput());
