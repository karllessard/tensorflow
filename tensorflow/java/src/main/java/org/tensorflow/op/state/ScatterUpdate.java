...
public final class ScatterUpdate<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> ScatterUpdate<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates) {
   ...
   * @return a new instance of ScatterUpdate
   **/
  public static <T, U> ScatterUpdate<T> create(Scope scope, Operand<T> ref, Operand<U> indices, Operand<T> updates, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ScatterUpdate", scope.makeOpName("ScatterUpdate"));
    opBuilder.addInput(ref.asOutput());
    opBuilder.addInput(indices.asOutput());
    opBuilder.addInput(updates.asOutput());
