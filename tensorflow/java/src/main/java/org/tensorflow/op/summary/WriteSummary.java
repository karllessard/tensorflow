...
public final class WriteSummary extends PrimitiveOp {
   ...
   **/
  public static <T> WriteSummary create(Scope scope, Operand<?> writer, Operand<Long> globalStep, Operand<T> tensor, Operand<String> tag, Operand<String> summaryMetadata) {
