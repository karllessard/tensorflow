...
public final class ApplyAdadelta<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> ApplyAdadelta<T> create(Scope scope, Operand<T> var, Operand<T> accum, Operand<T> accumUpdate, Operand<T> lr, Operand<T> rho, Operand<T> epsilon, Operand<T> grad) {
