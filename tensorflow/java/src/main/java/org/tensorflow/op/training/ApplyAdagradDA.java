...
public final class ApplyAdagradDA<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> ApplyAdagradDA<T> create(Scope scope, Operand<T> var, Operand<T> gradientAccumulator, Operand<T> gradientSquaredAccumulator, Operand<T> grad, Operand<T> lr, Operand<T> l1, Operand<T> l2, Operand<Long> globalStep) {
