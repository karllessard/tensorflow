...
public final class ApplyCenteredRMSProp<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T> ApplyCenteredRMSProp<T> create(Scope scope, Operand<T> var, Operand<T> mg, Operand<T> ms, Operand<T> mom, Operand<T> lr, Operand<T> rho, Operand<T> momentum, Operand<T> epsilon, Operand<T> grad) {
