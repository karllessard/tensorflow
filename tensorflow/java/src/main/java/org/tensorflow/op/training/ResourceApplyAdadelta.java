...
public final class ResourceApplyAdadelta extends PrimitiveOp {
   ...
   **/
  public static <T> ResourceApplyAdadelta create(Scope scope, Operand<?> var, Operand<?> accum, Operand<?> accumUpdate, Operand<T> lr, Operand<T> rho, Operand<T> epsilon, Operand<T> grad) {
