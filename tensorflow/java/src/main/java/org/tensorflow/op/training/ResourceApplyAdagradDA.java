...
public final class ResourceApplyAdagradDA extends PrimitiveOp {
   ...
   **/
  public static <T> ResourceApplyAdagradDA create(Scope scope, Operand<?> var, Operand<?> gradientAccumulator, Operand<?> gradientSquaredAccumulator, Operand<T> grad, Operand<T> lr, Operand<T> l1, Operand<T> l2, Operand<Long> globalStep) {
