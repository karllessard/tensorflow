...
public final class ResourceApplyFtrl extends PrimitiveOp {
   ...
   **/
  public static <T> ResourceApplyFtrl create(Scope scope, Operand<?> var, Operand<?> accum, Operand<?> linear, Operand<T> grad, Operand<T> lr, Operand<T> l1, Operand<T> l2, Operand<T> lrPower) {
