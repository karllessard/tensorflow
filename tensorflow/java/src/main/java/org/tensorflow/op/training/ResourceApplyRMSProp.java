...
public final class ResourceApplyRMSProp extends PrimitiveOp {
   ...
   **/
  public static <T> ResourceApplyRMSProp create(Scope scope, Operand<?> var, Operand<?> ms, Operand<?> mom, Operand<T> lr, Operand<T> rho, Operand<T> momentum, Operand<T> epsilon, Operand<T> grad) {
