...
public final class ResourceSparseApplyAdagradDA extends PrimitiveOp {
   ...
   * @param var
   * @param gradientAccumulator
   * @param gradientSquaredAccumulator
   * @param grad
   * @param indices
   * @param lr
   * @param l1
   ...
   **/
  public static <T, U> ResourceSparseApplyAdagradDA create(Scope scope, Operand<?> var, Operand<?> gradientAccumulator, Operand<?> gradientSquaredAccumulator, Operand<T> grad, Operand<U> indices, Operand<T> lr, Operand<T> l1, Operand<T> l2, Operand<Long> globalStep) {
   ...
   * @return a new instance of ResourceSparseApplyAdagradDA
   **/
  public static <T, U> ResourceSparseApplyAdagradDA create(Scope scope, Operand<?> var, Operand<?> gradientAccumulator, Operand<?> gradientSquaredAccumulator, Operand<T> grad, Operand<U> indices, Operand<T> lr, Operand<T> l1, Operand<T> l2, Operand<Long> globalStep, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ResourceSparseApplyAdagradDA", scope.makeOpName("ResourceSparseApplyAdagradDA"));
    opBuilder.addInput(var.asOutput());
    opBuilder.addInput(gradientAccumulator.asOutput());
    opBuilder.addInput(gradientSquaredAccumulator.asOutput());
