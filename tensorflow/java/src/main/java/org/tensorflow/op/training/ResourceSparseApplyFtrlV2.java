...
public final class ResourceSparseApplyFtrlV2 extends PrimitiveOp {
   ...
   **/
  public static <T, U> ResourceSparseApplyFtrlV2 create(Scope scope, Operand<?> var, Operand<?> accum, Operand<?> linear, Operand<T> grad, Operand<U> indices, Operand<T> lr, Operand<T> l1, Operand<T> l2, Operand<T> l2Shrinkage, Operand<T> lrPower) {
   ...
   * @return a new instance of ResourceSparseApplyFtrlV2
   **/
  public static <T, U> ResourceSparseApplyFtrlV2 create(Scope scope, Operand<?> var, Operand<?> accum, Operand<?> linear, Operand<T> grad, Operand<U> indices, Operand<T> lr, Operand<T> l1, Operand<T> l2, Operand<T> l2Shrinkage, Operand<T> lrPower, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ResourceSparseApplyFtrlV2", scope.makeOpName("ResourceSparseApplyFtrlV2"));
    opBuilder.addInput(var.asOutput());
    opBuilder.addInput(accum.asOutput());
    opBuilder.addInput(linear.asOutput());
