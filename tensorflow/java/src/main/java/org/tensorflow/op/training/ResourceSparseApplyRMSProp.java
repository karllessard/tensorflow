...
public final class ResourceSparseApplyRMSProp extends PrimitiveOp {
   ...
   **/
  public static <T, U> ResourceSparseApplyRMSProp create(Scope scope, Operand<?> var, Operand<?> ms, Operand<?> mom, Operand<T> lr, Operand<T> rho, Operand<T> momentum, Operand<T> epsilon, Operand<T> grad, Operand<U> indices) {
   ...
   * @return a new instance of ResourceSparseApplyRMSProp
   **/
  public static <T, U> ResourceSparseApplyRMSProp create(Scope scope, Operand<?> var, Operand<?> ms, Operand<?> mom, Operand<T> lr, Operand<T> rho, Operand<T> momentum, Operand<T> epsilon, Operand<T> grad, Operand<U> indices, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("ResourceSparseApplyRMSProp", scope.makeOpName("ResourceSparseApplyRMSProp"));
    opBuilder.addInput(var.asOutput());
    opBuilder.addInput(ms.asOutput());
    opBuilder.addInput(mom.asOutput());
