...
public final class SparseApplyFtrl<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> SparseApplyFtrl<T> create(Scope scope, Operand<T> var, Operand<T> accum, Operand<T> linear, Operand<T> grad, Operand<U> indices, Operand<T> lr, Operand<T> l1, Operand<T> l2, Operand<T> lrPower) {
   ...
   * @return a new instance of SparseApplyFtrl
   **/
  public static <T, U> SparseApplyFtrl<T> create(Scope scope, Operand<T> var, Operand<T> accum, Operand<T> linear, Operand<T> grad, Operand<U> indices, Operand<T> lr, Operand<T> l1, Operand<T> l2, Operand<T> lrPower, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("SparseApplyFtrl", scope.makeOpName("SparseApplyFtrl"));
    opBuilder.addInput(var.asOutput());
    opBuilder.addInput(accum.asOutput());
    opBuilder.addInput(linear.asOutput());
