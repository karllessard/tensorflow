...
public final class SparseApplyFtrlV2<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> SparseApplyFtrlV2<T> create(Scope scope, Operand<T> var, Operand<T> accum, Operand<T> linear, Operand<T> grad, Operand<U> indices, Operand<T> lr, Operand<T> l1, Operand<T> l2, Operand<T> l2Shrinkage, Operand<T> lrPower) {
   ...
   * @return a new instance of SparseApplyFtrlV2
   **/
  public static <T, U> SparseApplyFtrlV2<T> create(Scope scope, Operand<T> var, Operand<T> accum, Operand<T> linear, Operand<T> grad, Operand<U> indices, Operand<T> lr, Operand<T> l1, Operand<T> l2, Operand<T> l2Shrinkage, Operand<T> lrPower, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("SparseApplyFtrlV2", scope.makeOpName("SparseApplyFtrlV2"));
    opBuilder.addInput(var.asOutput());
    opBuilder.addInput(accum.asOutput());
    opBuilder.addInput(linear.asOutput());
