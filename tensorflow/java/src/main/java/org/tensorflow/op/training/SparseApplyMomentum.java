...
public final class SparseApplyMomentum<T> extends PrimitiveOp implements Operand<T> {
   ...
   **/
  public static <T, U> SparseApplyMomentum<T> create(Scope scope, Operand<T> var, Operand<T> accum, Operand<T> lr, Operand<T> grad, Operand<U> indices, Operand<T> momentum) {
   ...
   * @return a new instance of SparseApplyMomentum
   **/
  public static <T, U> SparseApplyMomentum<T> create(Scope scope, Operand<T> var, Operand<T> accum, Operand<T> lr, Operand<T> grad, Operand<U> indices, Operand<T> momentum, Options options) {
    OperationBuilder opBuilder = scope.graph().opBuilder("SparseApplyMomentum", scope.makeOpName("SparseApplyMomentum"));
    opBuilder.addInput(var.asOutput());
    opBuilder.addInput(accum.asOutput());
    opBuilder.addInput(lr.asOutput());
